...
#print (send_private_messaje(title='Test de Privacidad',IdTeamWorkUsers=IdTeamWorkUsersList,IdTeamWorkProject='418014',message=txt,notify=IdTeamWorkUsersList))
